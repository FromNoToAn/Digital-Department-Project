  ...
  - [Разделы](#разделы)
    ...
    7. [API взаимодействия](#7-api-взаимодействия)
        1. [Актуальные API эндпоинты](#71-актуальные-api-эндпоинты)
            ...
            2. [Управление потоком данных задачи](#712-управление-потоком-данных-задачи)
                1. [Отправка изображения для потока](#7121-отправка-изображения-для-потока)
                2. [Получение информации о потоке](#7122-получение-информации-о-потоке)
            3. [Управление данными задачи](#713-управление-данными-задачи)
                1. [Отправка данных задачи](#7131-отправка-данных-задачи)
                2. [Получение данных задачи](#7132-получение-данных-задачи)
            4. [Управление результатами задачи](#714-управление-результатами-задачи)
                1. [Отправка результатов задачи](#7141-отправка-результатов-задачи)
...
##### 7.1.2. Управление потоком данных задачи

###### 7.1.2.1. Отправка изображения для потока
- **Method:** POST
...
###### 7.1.2.2. Получение информации о потоке
- **Method:** GET
- **Endpoint:** {URL}/task/stream/{task_id}
- **Response:**
  ```json
...
###### 7.1.3.1. Отправка данных задачи
- **Method:** POST
...
###### 7.1.3.2. Получение данных задачи
- **Method:** GET
- **Endpoint:** {URL}/task/data/{task_id}
- **Response:**
  ```json
...
##### 7.1.4. Управление результатами задачи

###### 7.1.4.1. Отправка результатов задачи
- **Method:** POST
